// TivaCBulkPlugin.cpp : Defines the exported functions for the DLL application.
//
...
// A thin layer over WinUSB allowing device open/close/
...
//     the device path.
//****************************************************************************
extern "C" DWORD GetDevicePath(DWORD dwIndex, LPGUID InterfaceGuid,
	PCHAR  pcDevicePath,
	size_t BufLen)
{
	BOOL bResult = FALSE;
...
#define BULK_PID 0x0003
	return InitializeDevice(BULK_VID,
		BULK_PID,
...
//extern "C" BOOL PASCAL EXPORT 
TIVACBULKPLUGIN_API BOOL
TerminateDevice(LMUSB_HANDLE hUSB)
{
	BOOL bRetcode;
	BOOL bRetcode2;
	tDeviceInfoWinUSB *psDevInfo = (tDeviceInfoWinUSB *)hUSB;
...
//****************************************************************************
//extern "C" BOOL PASCAL EXPORT
TIVACBULKPLUGIN_API BOOL WriteUSBPacket(LMUSB_HANDLE hUSB, unsigned char *pcBuffer,
...
TIVACBULKPLUGIN_API DWORD ReadUSBPacket(LMUSB_HANDLE hUSB, unsigned char *pcBuffer, unsigned long ulSize,
