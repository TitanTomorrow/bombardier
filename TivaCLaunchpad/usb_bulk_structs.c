...
//
//*****************************************************************************
uint8_t g_pui8USBRxBuffer[BULK_RX_BUFFER_SIZE];
tUSBBuffer g_sRxBuffer =
{
    ...
    BULK_RX_BUFFER_SIZE,                // ui32BufferSize
};
...
//
//*****************************************************************************
uint8_t g_pui8USBTxBuffer[BULK_TX_BUFFER_SIZE];
tUSBBuffer g_sTxBuffer =
{
    ...
    BULK_TX_BUFFER_SIZE,                // ui32BufferSize
};
